...
namespace TheFrayedRedString.Motion
{
    ...
    public struct AmbientMotionProfile
    {
        ...
        /// <summary>
        /// Art that has to stay inside something: breathes inward and never
        /// moves.
        /// </summary>
        /// <remarks>
        /// <para>
        /// For an element parked hard against the edge of a panel, where the
        /// usual float pushes it out. The game's title art inside the load panel
        /// is the case this was written for: a drift of six units, a scale pulse
        /// of one and a half percent and two thirds of a degree of sway are all
        /// small on their own and together lifted its top edge clean out of the
        /// frame.
        /// </para>
        /// <para>
        /// The trick is the negative amplitude. With <see cref="ScaleGrowsOnly"/>
        /// the wave is remapped to 0..1, so a negative peak makes the element
        /// only ever <em>smaller</em> than the size it was authored at — which
        /// is the one shape of pulse that cannot push anything past an edge.
        /// Drift and sway are simply off.
        /// </para>
        /// </remarks>
        public static AmbientMotionProfile Inset => new AmbientMotionProfile
        {
