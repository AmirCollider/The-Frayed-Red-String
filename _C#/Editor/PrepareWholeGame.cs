...
namespace TheFrayedRedString.EditorTools
{
    ...
    {
        /// <summary>Acts that have a builder. Act one was written by hand.</summary>
        private static readonly int[] ScriptedActs = { 2, 3, 4, 5, 6, 7 };
        ...
        public static void Prepare()
        {
            ...
            try
            {
                ...
                Step(log, 5, "Act scripts", () => BuildScripts(policy, log));
        ...
        private static void BuildScripts(ActScriptWriter.RebuildPolicy policy, StringBuilder log)
        {
            ...
            ActAsset actOne = ActLibrary.Find(1);

            if (actOne == null || actOne.Count == 0)
            {
                log.AppendLine(
                    "     NOTE: act one has no script and no builder — it was written by hand in the " +
                    "Story Editor. Nothing here can regenerate it.");
            }
        }
