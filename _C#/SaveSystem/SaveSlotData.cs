...
namespace TheFrayedRedString.SaveSystem
{
    ...
    public struct SaveSlotData
    {
        ...
        /// </summary>
        /// <remarks>
        /// Saved for the same reason the choice counts are: the endings read it,
        /// and a playthrough of this length is not finished in one sitting. A
        /// slot written before this field existed reads back as zero, which is
        /// the honest answer for a run recorded before anyone was counting.
        /// </remarks>
        public int PatientMoments;
