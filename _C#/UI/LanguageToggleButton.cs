...
{
    /// <summary>
    /// Turns the authored ChangeLanguageButton into a working English ⇄
    /// Japanese toggle, complete with a card-flip animation on the flag.
    /// </summary>
    /// <remarks>
    ...
    public sealed class LanguageToggleButton : MonoBehaviour
    {
        ...
        {
            if (_flagImage == null || _library == null || !_library.HasFlags)
            {
                return;
            }
            ...
            _flagImage.sprite = shown == GameLanguage.Japanese
                ? _library.JapaneseFlag
                : _library.EnglishFlag;
        }
    }
}
