...
namespace TheFrayedRedString.Scenes
{
    ...
    public sealed class WarningSceneController : MonoBehaviour
    {
        ...
        /// So the labels use <see cref="LocalizedText.BindFixed"/> and ignore
        /// the active language entirely.
        /// </remarks>
        private void BindWarningText()
        {
            ...
            BindFixedLabel(ObjectNames.WarningTextEnglish, GameLanguage.English);
            BindFixedLabel(ObjectNames.WarningTextJapanese, GameLanguage.Japanese);
        }

        private static void BindFixedLabel(string objectName, GameLanguage language)
        {
            ...
            UnityUtility.GetOrAdd<LocalizedText>(target.gameObject)
                .BindFixed(LocKeys.WarningBody, language);
        }
