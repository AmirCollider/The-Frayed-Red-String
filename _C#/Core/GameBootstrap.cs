...
namespace TheFrayedRedString.Core
{
    ...
    public static class GameBootstrap
    {
        ...
        private static void ResetStatics()
        {
            ...
            VoiceLibrary.ResetStatics();
            VideoLibrary.ResetStatics();
            VoiceService.ResetStatics();
            StoryFonts.ResetStatics();
            StageSpriteLibrary.ResetStatics();
            StorySession.ResetStatics();
            StoryClock.ResetStatics();
            ActLibrary.ResetStatics();
            StageSettings.ResetStatics();
        ...
        private static void Initialize()
        {
            ...
            VoiceService.Install(ServiceHost);
