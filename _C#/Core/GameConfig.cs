...
namespace TheFrayedRedString.Core
{
    ...
    public static class GameConfig
    {
        ...
        /// <summary>
        /// Characters per second while a character is addressing the player.
        /// </summary>
        /// <remarks>
        /// Two thirds of the normal rate. Slow enough to feel like somebody
        /// choosing their words and not so slow that it reads as a bug — the
        /// line still finishes before an ordinary reader gets impatient.
        /// </remarks>
        public const float AsideTypeSpeed = 30f;

        /// <summary>How dark the room goes behind somebody speaking to the player.</summary>
        /// <remarks>
        /// Nearly half. This is the one effect in the game that is allowed to be
        /// obvious: the scene withdrawing is the signal, and a signal nobody
        /// notices is not one.
        /// </remarks>
        public const float AsideDim = 0.45f;

        /// <summary>How long the room takes to withdraw, and to come back.</summary>
        public const float AsideDimDuration = 1.4f;
