...
|---|---|---|---|
| `AutumnSchoolAlleyDay.png` | `SchoolAlleyDay` ✅ | پرده ۳ · پرده ۱ بعد از بازنویسیِ فصلی | مسیرِ سنگ‌فرشِ مدرسه با افراهای سرخ در چپ و برگ‌های طلایی در راست، برگ‌های ریخته روی سنگ‌فرش، نمای ساختمانِ سنتیِ مدرسه در راست، نیمکت‌های چوبی و فانوس‌های زمینی |
| `CherryBlossomSchoolAlleyDay.png` | `SchoolAlleySpring` | فلش‌بک و پایانِ رویا · موقتاً هم دو صحنه‌ی کوچه‌ی پرده ۱ ← ن۱۳ | همان مسیر با شکوفه‌های صورتیِ گیلاس در روزِ روشن. **در هیچ پرده‌ای فصلش نیست** — فقط خاطره و رویا |
...
| `HaruRoomSunnyDay.png` | `HaruRoomDay` | پرده ۵، پایان رویا / NG+ | اتاقِ هارو در روشناییِ روز، میز کامپیوتر در سمتِ چپ، کمد دیواری چوبی با در بسته در پشت، قفسه‌ی کتاب کوچک، تخت‌خواب با روتختی آبی در سمتِ راست زیرِ پنجره |
...
| # | نقص | وضعیت |
|---|---|---|
| ۲ | پس‌زمینه‌ی کوچه | **برطرف شد** — دو صحنه‌ی پرده ۱ تا بازنویسیِ فصلی روی تصویرِ شکوفه‌دار می‌مانند |
| ۳ | `PastelStreetVendingDay` و `TrainPlatformSunset` شکوفه‌ی گیلاس دارند و در سپتامبر تا دسامبر استفاده می‌شوند | باز |
| ۴ | **اتاقِ هارو با کمد:** تصویر `HaruRoomSunnyDay.png` ساخته و به پروژه افزوده شد. پایانِ پرده‌ی پنجم در خانه‌ی هارو محفوظ است | **برطرف شد** |
| ۵ | هیچ‌کدام از هشت پس‌زمینه‌ی پرده‌ی ششم، و هیچ‌کدام از اسپرایت‌های بچه، هنوز کشیده نشده‌اند | باز |
